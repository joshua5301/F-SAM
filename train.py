...
parser.add_argument('--gates', default='', type=str,
                    help="gate granularities: channel,channel_pre,channel_pre_write,"
                         ...
                         "channel_mat,channel_mix,conv_mix,conv_mat,conv_diag,all_mix,shuffle,branch,block,stage,logit,stream,"
                         "stream_dev; transformer: ln,ln_pre,ln_dev,head,head_dev,head_temp,mlp,mlp_dev "
                         "('' = none)")
